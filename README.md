...
破壊されると5秒ほどの時間をおいて再出現しますので、このすきをうまく使ってリングを攻略してください。

O-1MOのプロペラント残量はO-1MOの機体色に反映されています。
十分な残量があれば機体は緑色に、半分以下になれば黄色に、10%を切れば赤くなります。
燃料のなくなったO-1MO機は爆散し、5秒ほどの後に再度出現します。
